...
def downloadSampleFiles(username, password, startYear, endYear):
    ...
    with requests.session() as c:
        ...
        download_path = 'C:/Users/meena/OneDrive/Desktop/DeepLearning_udem/FreddieMac-s-US-Housing-and-Urban-Development-Loan-Data-Analysis-master/Part1/Data/SampleFiles'
		#print(download_path)
...
def combineOrigFiles():
    ...
    filedirectory_path = 'C:/Users/meena/OneDrive/Desktop/DeepLearning_udem/FreddieMac-s-US-Housing-and-Urban-Development-Loan-Data-Analysis-master/Part1/Data'
...
def main():
    ...
    downloadSampleFiles(username='meenalbadki3@gmail.com', password='colourblind', startYear='2003', endYear='2009')
    combineOrigFiles()
    combinePerfFiles()
